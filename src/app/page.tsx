...
export default function Home() {
  return (
    <div className="h-full  w-full flex items-center md:items-start md:justify-start justify-center mx-auto px-4 md:pt-20  font-[family-name:var(--font-geist-sans)]">
